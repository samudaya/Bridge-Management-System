...
<?php	
	...
	echo "<p class=\"hx1\">Photos and Sketches Record</p>";
	...
	if(isset($_POST['yes_submit']))
	{
		...
		////////////////////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////////////////////
		$query_resource = "insert into bms_inspection2headerdatas(bridgeprofile_BridgeProfileID, 
														InspectionDate, 
														NextInspectionDate,
														Level1Inspection,
														AddedBy, 
		...
		$query_master	= "select Inspection2HeaderDataID from bms_inspection2headerdatas where bridgeprofile_BridgeProfileID =  '".$BridgeProfileID."' and InspectionDate = '".$dateofinspection."' and NextInspectionDate = '".$dateofninspection."' and Level1Inspection = '".$level1ins."' and AddedBy = '".$AddedBy."' and AddedDate = '".$AddedDate."' ";
		...
		{	
			$Inspection2HeaderDataID = $row_master['Inspection2HeaderDataID'];
		}
		...
		for ( $i = 1; $i <= 20; $i++)
		{
					...
					if(isset($_POST[$field1]))
					{
						...
						$target = $datadir2; 
						$target1 = $target . $Inspection2HeaderDataID."-".$i.".".$lcase_ext;
						move_uploaded_file($_FILES['sketch'.$i.'name']['tmp_name'],$target1);
						
						////////////////////////////////////////////////////////////////////////////////////
						////////////////////////////////////////////////////////////////////////////////////
						
						$query_resource = "insert into bms_inspection2datas(`bms_inspection2headerdatas_Inspection2HeaderDataID`, 
																		`ival`,														
																		`Filmnumber`,
																		`Sketchnumber`,
																		`Modification`,
																		...
																		`Filext`,
																		`Description`) 
															values ('".$Inspection2HeaderDataID."', 
																	'".$ival."',													
																	'".$filmnumber."',
																	'".$sketchnumber."', 
																	'".$modification."',													
				...
				<?php
					...
					echo " <table>
						...
						for($i=1; $i <= 20; $i++)
						{
							echo "	
									<tr>
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox1\" name=\"filmnumber".$i."name\"  oninput=\"ajaxFunction();\"  id=\"filmnumber".$i."name\" >
									</td>									
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox1\" name=\"sketchnumber".$i."name\"  oninput=\"ajaxFunction();\"  id=\"sketchnumber".$i."name\" >
									</td>
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox1\" name=\"modification".$i."name\"  oninput=\"ajaxFunction();\"  id=\"modification".$i."name\" >
									</td>
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox1\" name=\"group".$i."name\"  oninput=\"ajaxFunction();\"  id=\"group".$i."name\" >
									</td>
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox2\" name=\"component".$i."name\"  oninput=\"ajaxFunction();\"  id=\"component".$i."name\" >
									</td>
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox2\" name=\"description".$i."name\"  oninput=\"ajaxFunction();\"  id=\"description".$i."name\" >
									</td>
