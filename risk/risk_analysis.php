<?php
	...
	if(!isset($_POST['more'])){
		unset($_SESSION['more']);
		unset($_SESSION['Inspection3HeaderDataID']);
	}	
...
<?php	
	...
	if(isset($_POST['SearchString']) and $BridgeProfileID>0 )
	{
				...
				else
				{
					...
					while($row_fac = mysql_fetch_array($result_fac))
					{
						...
						else
						{
							...
							echo "<input type=\"submit\" name=\"more\" value=\"Calculate Risk\"  class=\"Submit_Button_long_long\" />";	
			...
			<table align=\"right\">
				<tr>
					<td>
						<a  target=\"_blank\" href=\"./risk_analysis_main_01.php\"><input type=\"button\" name=\"print\" value=\"Print\" class=\"Submit_Button_Long\"></a>
					</td>
				</tr>
			</table>
			";
	...
	if(isset($_POST['more']))
	{
			...
			<table align=\"right\">
				<tr>
					<td>
						<a  target=\"_blank\" href=\"./risk_analysis_more_main_01.php\"><input type=\"button\" name=\"print\" value=\"Print\" class=\"Submit_Button_Long\"></a>
					</td>
				</tr>
			</table>
			";
