...
<?php	
	...
	echo "
	<p class=\"hx1\">Help - Standard Numbers</p>";
	
	$query_compList = "select * from bms_inspection3stcompschedule";
	...
	while($row_compList = mysql_fetch_array($result_compList)){
		...
		$scheduleNo 	= $row_compList['Inspection3StcompScheduleNo'];
		$scheduleDesc 	= $row_compList['Inspection3StcompScheduleDesc'];
		$scheduleUnit 	= $row_compList['Inspection3StcompScheduleUnit'];
		if($row_compList['Inspection3StcompScheduleID'] == 0){
			continue;
		}
		echo "
			<tr>
