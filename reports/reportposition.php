...
<?php	
	...
	echo "<p class=\"hx1\">Views of Bridges by Location</p>";
			...
			echo "<form name=\"view_fac\" id=\"view_fac\" method=\"POST\" autocomplete=\"off\" action=\"#\">";				
				echo "<table>";
					...
					echo "<tr>";
						...
						echo "</td>";
						echo "<td class=\"mytd\">";
							$query_ea		= "select ProvinceID, Province from bms_provinces order by Province";		
							$result_ea		= mysql_query($query_ea) or die (mysql_error());
							
							echo "<select name=\"Province\" class=\"myselect1\">";
								echo "<option>All </option>";
								while($row_ea	= mysql_fetch_array($result_ea))
								{
									$temp++;
									$ProvinceID = $row_ea['ProvinceID'];
									$Province	= $row_ea['Province'];
									if(isset($_POST['ProvinceID']) and ($_POST['ProvinceID'] == $ProvinceID))
									{
										echo "<option value=\"".$ProvinceID."\" selected=\"selected\">".$Province."</option>";
									}
									else
									{
						...
						echo "<td class=\"altmytd\">";
							...
							echo "<select name=\"District\" class=\"myselect1\" >";
								...
								while($row_ea	= mysql_fetch_array($result_ea))
								{
									...
									if(isset($_POST['DistrictID']) and ($_POST['DistrictID'] == $DistrictID))
									{
						...
						echo "</td>";
						echo "<td class=\"mytd\">";
							$query_hea		= "select RoadNameID, RoadName from bms_roadnames";		
							$result_hea		= mysql_query($query_hea) or die (mysql_error());
							echo "<select name=\"RoadName\" class=\"myselect1\" >";
								echo "<option>All </option>";
								while($row_hea	= mysql_fetch_array($result_hea))
								{
									...
									{
										echo "<option value=\"".$RoadNameID."\" selected=\"selected\">".$RoadName."</option>";
									}
									else
									{
										echo "<option value=\"".$RoadNameID."\" >".$RoadName."</option>";
									}
								}
							echo "</select>";							
							echo "</td>";
		...
		if (isset ($_POST['select'])){
			...
			$arr_lenth = 0;
			if ($Province != "All"){
				$Province = "provinces_ProvinceID = '".$Province."'";
				$searcharray [$arr_lenth] = $Province ;
				$arr_lenth++;
			}
			if($District != "All"){
			...
			if($Road != "All"){
				$Road = "roadnames_RoadNameID = '".$Road."'";
				$searcharray [$arr_lenth] = $Road ;
				$arr_lenth++;
			}
				...
				while($row_fac = mysql_fetch_array($result_fac))
				{
					...
					else
					{
						echo "<td class=\"altmytd\">";				
							...
							$query_ea		= "select ProvinceID, Province from bms_provinces where ProvinceID = ".$provinces_ProvinceID;		
							$result_ea		= mysql_query($query_ea) or die (mysql_error());
		...
		<?php
			...
			echo "<table class=\"bodytext\">
				<tr>
					...
					<td class=\"mytd\" width=\"400\">mmmm".$StructureID."</td>
