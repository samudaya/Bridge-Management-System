...
<?php	
	...
	echo "
	<p class=\"hx1\">Help - Group List</p>";
	
	$query_compList = "select * from bms_inspection3stcompmatrixgroup";
	...
	while($row_compList = mysql_fetch_array($result_compList)){
		...
		$groupCode 	= $row_compList['StcompMatrixGroupCode'];
		$groupDesc 	= $row_compList['StcompMatrixGroupDesc'];
		if($row_compList['Inspection3StcompMatrixGroupID'] == 0){
			continue;
		}
		echo "
			<tr>
