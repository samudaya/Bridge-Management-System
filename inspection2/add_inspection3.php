...
<?php	
	...
	echo "<p class=\"hx1\">Structure Condition Inspection Report</p>";
	...
	if(isset($_POST['yes_submit']))
	{
		...
		$query_master	= "select max(Inspection3HeaderDataID) as maxID from bms_inspection3headerdatas";
		$result_master	= mysql_query($query_master) or die (mysql_error());

		while($row_master	= mysql_fetch_array($result_master))
		{	
			$maxID = $row_master['maxID'];
		}
		$Inspection3HeaderDataID = $maxID + 1;
		...
		////////////////////////////////////////////////////////////////////////////////////
		$query_resource = "insert into bms_inspection3headerdatas(Inspection3HeaderDataID,
														...
														AddedBy, 
														AddedDate) 
											values ('".$Inspection3HeaderDataID."',
													'".$BridgeProfileID."', 
													'".$dateofinspection."', 
													'".$dateofninspection."',
													'".$level2ins."',
		...
		//$Inspection3HeaderDataID = $Inspection3HeaderDataID + 1;
		////////////////////////////////////////////////////////
		...
		for ($i = 1; $i <= 1000; $i++)
		{
			...
			if(isset($_POST[$modfiCIRP]))
			{
						...
						////////////////////////////////////////////////////////////////////////////////////
						////////////////////////////////////////////////////////////////////////////////////
					$query_resourceCIR = "insert into bms_inspection3stconinsdatas(bms_inspection3headerdatas_Inspection3HeaderDataID, 
																		Modification,
																		ival,														
																		bms_inspection3stcompmatrix_Inspection3StcompMatrixGroupID,
																		Inspection3StcompMatrixGroupVal,
																		bms_inspection3stcompmatrix_Inspection3StcompMatrixID_CM,
																		Inspection3StcompMatrixVal_CM, 
																		bms_inspection3stcompschedule_Inspection3StcompScheduleID,
																		ExporsureClass, 
																		ImportanceFactor,
																		Quantity,
																		QuantityConState_1,
		...
		for ($i = 1; $i <= 20; $i++)
		{
			...
			if(isset($_POST[$modfiDCRP]))
			{
						...
						////////////////////////////////////////////////////////////////////////////////////
						////////////////////////////////////////////////////////////////////////////////////
					$query_resourceCIR = "insert into bms_inspection3defcomdatas(bms_inspection3headerdatas_Inspection3HeaderDataID, 
																		Modification,
																		ival,														
																		bms_inspection3stcompmatrix_Inspection3StcompMatrixGroupID,
																		Inspection3StcompMatrixGroupVal,
		...
		for ($i = 1; $i <= 20; $i++)
		{
			...
			if(isset($_POST[$modfisketchP]))
			{
					...
					move_uploaded_file($_FILES['sketch'.$i.'name5']['tmp_name'],$target5);
						...
						////////////////////////////////////////////////////////////////////////////////////
						////////////////////////////////////////////////////////////////////////////////////
					$query_resourceCIR = "insert into bms_inspection3photosketchdatas(bms_inspection3headerdatas_Inspection3HeaderDataID, 
																		Modification,
																		ival,														
																		bms_inspection3stcompmatrix_Inspection3StcompMatrixGroupID,
																		Inspection3StcompMatrixGroupVal,
	...
	if(isset($_POST['SearchString']) and $BridgeProfileID>0 )
	{
			...
			<div id="tabs">
					...
					echo " <table>
						...
						for($i=1; $i <= 1000; $i++)
						{
							echo "	
									...
									<td class=\"mytd\" >";
											$query_cea		= "select * from bms_inspection3stcompmatrixgroup order by Inspection3StcompMatrixGroupID";	
											$result_cea		= mysql_query($query_cea) or die (mysql_error());
											echo "<table><tr><td class=\"mytd0\" >";
											echo "<select name=\"groupCIR".$i."\" id=\"groupCIR".$i."\" class=\"myselect00\">";
												while($row_cea	= mysql_fetch_array($result_cea)){
													...
													echo "<option value=\"".$Inspection3StcompMatrixID."\" >".$StcompMatrixCode."</option>";
												};
											echo "
										</select>";
										echo "</td><td class=\"mytd0\" >";
										
										echo "<select name= \"groupNoCIR".$i."\" id=\"groupNoCIR".$i."\" class=\"myselect00\">";
										$x = 1;
										while($x < 20){
									...
									<td class=\"mytd\" >";
											...
											echo "</td><td class=\"mytd0\" >";
										echo "<select name= \"componentNoCIR".$i."\" id=\"componentNoCIR".$i."\" class=\"myselect00\">";
										$x = 1;
										while($x < 20){
											echo "<option value=\"".$x."\" >".$x."</option>";
											$x++;
									...
									<td class=\"mytd\" align=\"center\">
										<span name=\"significance_rate".$i."\" id=\"significance_rate".$i."\">---</span>
									</td>
									<td class=\"mytd\"  align=\"center\" >";
											...
											echo "<select name=\"standardNoCIR".$i."\" id=\"standardNoCIR".$i."\" class=\"myselect00\">";
												while($row_cea	= mysql_fetch_array($result_cea)){
													...
													echo "<option value=\"".$Inspection3StcompScheduleID."\" >".$Inspection3StcompScheduleNo."</option>";
												};
											echo "
										</select>
									</td>	
									...
									<td class=\"mytd\" align=\"center\">
										<select name=\"phTakenCIR".$i."\">
												<option value=\"-\">---</option>
												<option value=\"y\">Yes</option>
												<option value=\"n\">No</option>
										</select>
									</td>
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox2\" name=\"commentCIR".$i."name\"  oninput=\"ajaxFunction();\"  id=\"commentCIR".$i."name\" >
									</td>";
									echo "
				...
				<?php
					echo " <table>
											<tr>
											<td class=\"myth\" >Modification</td>
											<td class=\"myth\" >Group</td>
											<td class=\"myth\" >Component</td>
											<td class=\"myth\" >Standard Number</td>
											<td class=\"myth\" >Exposure Factor</td>
											<td class=\"myth\" >Condition State</td>
						...
						for($i=1; $i <= 20; $i++)
						{
							echo "	
									...
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox2\" name=\"descripDCR".$i."name\"  oninput=\"ajaxFunction();\"  id=\"descripCIR".$i."name\" >
									</td>									
									<td class=\"mytd\" align=\"center\" >
					...
					echo " <table>
						...
						for($i=1; $i <= 20; $i++)
						{
							echo "	
									...
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox2\" name=\"dessketch".$i."name\"  oninput=\"ajaxFunction();\"  id=\"dessketch".$i."name\" >
									</td>									
									<td class=\"mytd\" width=\"100\"> <input type=\"text\" class=\"mytextbox2\" name=\"sketchno".$i."name\"  oninput=\"ajaxFunction();\"  id=\"sketchno".$i."name\" >
									<td  class=\"mytd\" width=\"100\">";
									//////////////////////////////////////////////////////////////////////
									////////////// File Uploading ////////////////////////////////////////
									//////////////////////////////////////////////////////////////////////
									echo "<input type=\"file\" class=\"mytextbox3\" name=\"sketch".$i."name1\" id=\"sketch".$i."name1\" >";
									echo "</td>
									<td  class=\"mytd\" width=\"100\">";
									echo "<input type=\"file\" class=\"mytextbox3\" name=\"sketch".$i."name2\" id=\"sketch".$i."name2\" >";
									echo "</td>
									<td  class=\"mytd\" width=\"100\">";
									echo "<input type=\"file\" class=\"mytextbox3\" name=\"sketch".$i."name3\" id=\"sketch".$i."name3\" >";
									echo "</td>
									<td  class=\"mytd\" width=\"100\">";
									echo "<input type=\"file\" class=\"mytextbox3\" name=\"sketch".$i."name4\" id=\"sketch".$i."name4\" >";
									echo "</td>
									<td  class=\"mytd\" width=\"100\">";
									echo "<input type=\"file\" class=\"mytextbox3\" name=\"sketch".$i."name5\" id=\"sketch".$i."name5\" >";
									echo "</td>";
									echo "
									<span name=\"des\" id=\"des\"></span></td>
									</tr>
