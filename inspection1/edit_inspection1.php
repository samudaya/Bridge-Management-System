...
?>
	...
	<script>
		...
		function checkOnSubmit(){
			valid = true;
			if ( document.myfirstformyy.dateofinspection.value == "" )
				{
			...
			if ( document.myfirstformyy.dateofninspection.value == "" )
				{
...
<?php	
	...
	echo "<p class=\"hx1\">Edit Routine Maintenance Inspection Report</p>";
	...
	if(isset($_POST['yes_submit']))
	{
		...
		$query_resource = "update bms_inspection1headerdatas set InspectionDate = '$dateofinspection', NextInspectionDate = '$dateofninspection', Level1Inspection = '$level1ins', GeneralComment = '$comment', ModifiedBy = '$ModifiedBy', ModifiedDate = '$ModifiedDate' where Inspection1HeaderDataID = '$Inspection1HeaderDataID'";
			...
			{	
				for ( $k = 1; $k <= 7; $k++)
				{
					...
					if(isset($_POST[$select1val]))
					{
						...
						////////////////////////////////////////////////////////////////////////////////////
						////////////////////////////////////////////////////////////////////////////////////
						$query_resource = "update bms_inspection1datas set Problem = '$problem', Comment = '$comment', Rectified = '$rectified', MaintainaceRequired = '$maintainacerequired', InspectionRequired = '$inspectionrequired' where bms_inspection1headerdatas_Inspection1HeaderDataID = '$Inspection1HeaderDataID' and ijkval = '$ijkval'";
					...
					<tr>			
						...
						<td class=\"mytd\">
							<select name=\"level1ins\">
								...
								echo " >Exceptional</option>
								<option value=\"p\" ";
									if($Level1Inspection == "p"){
										echo "selected = 'selected'";
									}
								echo " >Programmed</option>
							</select>
						</td>			
					</tr>										
								...
								echo "</br>";
									...
									while($row_sec	= mysql_fetch_array($result_sec))
									{
										...
										echo "	
												...
												<td class=\"mytd\"> <input type=\"text\" class=\"mytextbox3\" name=\"text$i$j$k\"  oninput=\"ajaxFunction();\"  id=\"$Inspection1SecondaryInfo\" value=\"$Comment\">
							...
							echo "<table class=\"bodytext\">";
								echo "<tr>";
									...
									echo "<textarea name=\"comment\" cols=\"140\" rows=\"12\">".$GeneralComment."</textarea>";
										//echo "<input type=\"text\" class=\"mytextbox3\" name=\"comment\" id=\"comment\" value=\"\" >";
									echo "</td>";
								echo "</tr>";
