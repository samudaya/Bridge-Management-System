...
if((isset($_POST['SearchString']) and $BridgeProfileID>0 and $_SESSION['log_UserID']> 0) or ($_POST['BridgeProfileIDX']>0))
{
	...
	<div id="tabs">
		...
		<?php		
			...
			<table align=\"right\">
				<tr>
					<td>
						<a  target=\"_blank\" href=\"./view_bridge_more_main_01.php\"><input type=\"button\" name=\"print\" value=\"Print\" class=\"Submit_Button_Long\"></a>
					</td>
				</tr>
			</table>
			";
